...
intptr_t *emscripten_get_sbrk_ptr(void) EM_ENV_IMPORT(emscripten_get_sbrk_ptr);
...
int emscripten_resize_heap(size_t requested_growth_bytes) EM_ENV_IMPORT(emscripten_resize_heap);
